...
let s:vimwiki_defaults["diary_rel_path"] = "journal/2024"
...
let g:vimwiki_wiki_job_base_path = $HOME."/work/job"
let g:vimwiki_wiki_job = deepcopy(s:vimwiki_defaults)
let g:vimwiki_wiki_job["name"] = "Job"
let g:vimwiki_wiki_job["path"] = g:vimwiki_wiki_job_base_path."/wiki"
let g:vimwiki_wiki_job["path_html"] = g:vimwiki_wiki_job_base_path."/.wiki_html"
let g:vimwiki_list += [ g:vimwiki_wiki_job  ]  " #3
...
let g:vimwiki_wiki_sandbox["diary_rel_path"] = "journal"
let g:vimwiki_list += [ g:vimwiki_wiki_sandbox  ]  " #4
...
let g:taskwiki_wiki_job = { }
let g:taskwiki_wiki_job["taskrc_location"] = g:vimwiki_wiki_job["path"]."/tasks/taskrc"
let g:taskwiki_wiki_job["data_location"] = g:vimwiki_wiki_job["path"]."/tasks/data"
let g:taskwiki_extra_warriors["J"] = g:taskwiki_wiki_job
