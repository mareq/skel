...
#
# Originally generated by Powerlevel10k configuration wizard on 2019-12-08 at 16:28 GMT.
...
() {
  ...
  function my_git_formatter() {
    ...
    if (( $1 )); then
      ...
      local conflicted='%69F'   # blue foreground
    else
  ...
  # Icon color.
  typeset -g POWERLEVEL9K_VCS_VISUAL_IDENTIFIER_COLOR=231
  ...
  typeset -g POWERLEVEL9K_BACKGROUND_JOBS_FOREGROUND=105
  # Icon to show when there are background jobs.
  typeset -g POWERLEVEL9K_BACKGROUND_JOBS_VISUAL_IDENTIFIER_EXPANSION='${P9K_VISUAL_IDENTIFIER// }'

  #######################[ direnv: direnv status (https://direnv.net/) ]########################
  # Direnv color.
  typeset -g POWERLEVEL9K_DIRENV_FOREGROUND=69
  ...
  typeset -g POWERLEVEL9K_VIM_SHELL_FOREGROUND=82
  ...
  typeset -g POWERLEVEL9K_VI_MODE_NORMAL_FOREGROUND=82
  # Text and color for visual vi mode.
  typeset -g POWERLEVEL9K_VI_VISUAL_MODE_STRING=VISUAL
  typeset -g POWERLEVEL9K_VI_MODE_VISUAL_FOREGROUND=69
  # Text and color for overtype (a.k.a. overwrite and replace) vi mode.
  typeset -g POWERLEVEL9K_VI_OVERWRITE_MODE_STRING=OVERTYPE
  typeset -g POWERLEVEL9K_VI_MODE_OVERWRITE_FOREGROUND=220
  ...
  typeset -g POWERLEVEL9K_LOAD_NORMAL_FOREGROUND=82
  ...
  # Show the current Python version if it's the same as global.
  ...
  # Show the current Go version if it's the same as global.
  ...
  ##########[ nodenv: node.js version from nodenv (https://github.com/nodenv/nodenv) ]##########
  # Nodenv color.
  typeset -g POWERLEVEL9K_NODENV_FOREGROUND=119
  # Show node version if it's the same as global: $(nodenv version-name) == $(nodenv global).
  ...
  ##############[ nvm: node.js version from nvm (https://github.com/nvm-sh/nvm) ]###############
  # Nvm color.
  typeset -g POWERLEVEL9K_NVM_FOREGROUND=119
  # Custom icon.
  # typeset -g POWERLEVEL9K_NVM_VISUAL_IDENTIFIER_EXPANSION='⭐'

  ############[ nodeenv: node.js environment (https://github.com/ekalinin/nodeenv) ]############
  # Nodeenv color.
  typeset -g POWERLEVEL9K_NODEENV_FOREGROUND=119
  # Show Node version next to the environment name.
  ...
  ##############################[ node_version: node.js version ]###############################
  # Node version color.
  typeset -g POWERLEVEL9K_NODE_VERSION_FOREGROUND=119
  ...
  #######################[ go_version: go version (https://golang.org) ]########################
  # Go version color.
  typeset -g POWERLEVEL9K_GO_VERSION_FOREGROUND=87
  ...
  ###############[ dotnet_version: .NET version (https://dotnet.microsoft.com) ]################
  # .NET version color.
  typeset -g POWERLEVEL9K_DOTNET_VERSION_FOREGROUND=87
  ...
  #############[ rbenv: ruby version from rbenv (https://github.com/rbenv/rbenv) ]##############
  # Rbenv color.
  typeset -g POWERLEVEL9K_RBENV_FOREGROUND=160
  ...
  #######################[ rvm: ruby version from rvm (https://rvm.io) ]########################
  # Rvm color.
  typeset -g POWERLEVEL9K_RVM_FOREGROUND=160
  # Do show @gemset at the end.
  typeset -g POWERLEVEL9K_RVM_SHOW_GEMSET=true
  # Do show ruby- at the front.
  ...
  typeset -g POWERLEVEL9K_AZURE_FOREGROUND=33
  # Custom icon.
  ...
  ###############################[ public_ip: public IP address ]###############################
  # Public IP color.
  typeset -g POWERLEVEL9K_PUBLIC_IP_FOREGROUND=220
  # Custom icon.
  ...
  typeset -g POWERLEVEL9K_BATTERY_LOW_THRESHOLD=33
  typeset -g POWERLEVEL9K_BATTERY_LOW_FOREGROUND=196
  # Show battery in green when it's charging or fully charged.
  typeset -g POWERLEVEL9K_BATTERY_{CHARGING,CHARGED}_FOREGROUND=82
  ...
  # Transient prompt works similarly to the builtin transient_rprompt option. It trims down promp
